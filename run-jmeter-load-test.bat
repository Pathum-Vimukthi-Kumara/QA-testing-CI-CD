...
:: Use quotes around paths with parentheses
cd "D:\QA\apache-jmeter-5.6.3(1)\apache-jmeter-5.6.3\bin"
jmeter.bat -n -t "D:\QA\Driving-License-Tracker\login-load-test.jmx" -l "D:\QA\Driving-License-Tracker\%RESULTS_FILE%" -e -o "D:\QA\Driving-License-Tracker\%REPORT_DIR%"
...
cd "D:\QA\Driving-License-Tracker"
pause
